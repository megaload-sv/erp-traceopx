    ...
    public function run(): void
    {
        ...
        $rows = [
            [
                ...
                'quotation_delivery_minutes' => 1440,
            ],
            [
                'code' => 'EMAIL',
                ...
                'quotation_delivery_minutes' => 2880,
            ],
            [
                'code' => 'MANUAL',
                'name' => 'Ingreso manual',
        ...
        foreach ($rows as $row) {
            $existing = $this->db->table('commercial_sla_policies')
                ->where('code', $row['code'])
                ->get()
                ->getRowArray();
            ...
            if ($existing === null) {
                $this->db->table('commercial_sla_policies')->insert($payload + [
                    'entry_user' => 'system',
                    'entry_date' => $now,
                ]);
                continue;

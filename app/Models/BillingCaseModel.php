...
class BillingCaseModel extends BaseModel
{
    ...
    protected $allowedFields = [
        ...
        'balance_amount','payment_term_code_snapshot','payment_term_name_snapshot',
        'mh_operation_condition_code_snapshot','mh_credit_term_code_snapshot','mh_credit_period_snapshot','planned_payment_methods_json',
        'notes','prepared_by_user_id','prepared_at','entry_user','modify_user','delete_user'
    ];

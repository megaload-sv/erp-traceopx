...
class QuotationService
{
    public function createDraft(array $data): int
    {
        ...
        $id = $model->insert([
            ...
            'mh_operation_condition_code' => $data['mh_operation_condition_code'] ?? null,
            'mh_credit_term_code' => $data['mh_credit_term_code'] ?? null,
            'mh_credit_period' => $data['mh_credit_period'] ?? null,

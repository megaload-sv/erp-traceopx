...
<aside class="space-y-6 xl:sticky xl:top-6 xl:self-start">
    <section class="rounded-2xl bg-slate-950 p-6 text-white shadow-xl">
        ...
        <?php elseif ($approved): ?><div class="mt-5 rounded-xl border border-emerald-900 bg-emerald-950/30 p-4"><p class="font-bold text-emerald-200">Plan listo para Orden de Trabajo</p><p class="mt-1 text-xs text-emerald-300">La siguiente etapa generará la OT desde esta planificación aprobada.</p></div>

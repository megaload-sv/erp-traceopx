...
<aside class="w-full bg-slate-950 px-6 py-6 text-white lg:min-h-screen lg:w-72">
    ...
    <nav class="space-y-2">
        ...
        <span class="block rounded-lg px-4 py-3 text-slate-500">Órdenes de trabajo</span><span class="block rounded-lg px-4 py-3 text-slate-500">Facturación y cobros</span>
    </nav>
</aside>
